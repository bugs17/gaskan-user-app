...
import { ChatBubbleBottomCenterTextIcon as ChatSolid } from "react-native-heroicons/solid";
import { ChatBubbleBottomCenterTextIcon as ChatOutline } from "react-native-heroicons/outline";
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ color, focused }) => {
            ...
            return focused ? (
              <HomeSolid size={32} color="#532dffff" />
            ) : (
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ color, focused }) => {
            // Gunakan solid jika aktif, outline jika tidak aktif
            return focused ? (
              <ReceiptPercentIconSolid size={32} color="#532dffff" />
            ) : (
      ...
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ color, focused }) => {
            // Gunakan solid jika aktif, outline jika tidak aktif
            return focused ? (
              <UserSolid size={32} color="#532dffff" />
            ) : (
